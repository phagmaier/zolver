...
pub fn main(init: std.process.Init) !void {
    ...
    const royal_flush = [7]u32{
        ...
        Card.makeCard(0, 1), // 2 of Hearts (kicker)
        Card.makeCard(1, 2), // 3 of Diamonds (kicker)
    };

    // 3. Create a High Card hand
    const high_card = [7]u32{
        Card.makeCard(12, 0), // Ace of Spades
        Card.makeCard(7, 1), // 9 of Hearts
        Card.makeCard(5, 2), // 7 of Diamonds
        Card.makeCard(3, 3), // 5 of Clubs
        Card.makeCard(1, 0), // 3 of Spades
        Card.makeCard(0, 1), // 2 of Hearts
        Card.makeCard(4, 2), // 6 of Diamonds
    };
